...
import ir.sinapps.sinapps.app.ReviewStorageIterator;
import ir.sinapps.sinapps.app.fragment.Abstract;
import ir.sinapps.sinapps.app.model.App;
import ir.sinapps.sinapps.app.model.ImageSource;
import ir.sinapps.sinapps.app.task.LoadImageTask;
import ir.sinapps.sinapps.app.task.playstore.ReviewDeleteTask;
import ir.sinapps.sinapps.app.task.playstore.ReviewLoadTask;
import ir.sinapps.sinapps.app.view.UriOnClickListener;
import ir.sinapps.sinapps.app.view.UserReviewDialogBuilder;
...
public class Review extends Abstract {
    ...
    public void draw() {
        ...
        activity.findViewById(R.id.reviews_panel).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ir.sinapps.sinapps.app.model.Review review = app.getUserReview();
    ...
    public void fillUserReview(ir.sinapps.sinapps.app.model.Review review) {
        clearUserReview();
    ...
    private ir.sinapps.sinapps.app.model.Review getUpdatedUserReview(ir.sinapps.sinapps.app.model.Review oldReview, int stars) {
        ir.sinapps.sinapps.app.model.Review review = new ir.sinapps.sinapps.app.model.Review();
    ...
    public void showReviews(List<ir.sinapps.sinapps.app.model.Review> reviews) {
        ...
        for (ir.sinapps.sinapps.app.model.Review review: reviews) {
    ...
    private void addReviewToList(ir.sinapps.sinapps.app.model.Review review, ViewGroup parent) {
