...
import ir.sinapps.sinapps.app.model.Review;
import ir.sinapps.sinapps.app.model.ReviewBuilder;

import java.io.IOException;

public class ReviewAddTask extends PlayStorePayloadTask<Review> {

    private ir.sinapps.sinapps.app.fragment.details.Review fragment;
    private String packageName;
    private Review review;

    public void setFragment(ir.sinapps.sinapps.app.fragment.details.Review fragment) {
    ...
    public void setReview(ir.sinapps.sinapps.app.model.Review review) {
        this.review = review;
    }
